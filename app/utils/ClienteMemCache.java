...
public class ClienteMemCache extends MemcachedClient{
	

	public ClienteMemCache (String username, String password, String servers) throws IOException {
		this(new SASLConnectionFactoryBuilder().build(username, password), getAddresses(servers));
	}
	
	public ClienteMemCache(ConnectionFactory cf, List<InetSocketAddress> addrs) throws IOException {
	       super(cf, addrs);
	   }
